...
<head>
    ...
    <title>Jaga Jagung Giriroto</title>
...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1>Selamat Datang di Jaga Jagung Giriroto</h1>
            <h2>Kami Siap Mengatasi Permasalahan Tanaman Jagung di Desa Giriroto</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Mengapa Harus Jaga Jagung Giriroto?</h3>
                            <p>
                                Karena Jaga Jagung Giriroto adalah aplikasi yang membantu para petani dalam mendiagnosis
                                kesehatan tanaman jagung di Desa Giriroto dengan menggunakan sistem pakar. Kami percaya
                            ...
                            <div class="row">
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>Memberikan solusi terkait kesehatan tanaman jagung berdasarkan gejala-gejala
                                            yang ada</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4>Assisting Farmers</h4>
                                        <p>Bertujuan untuk membantu petani-petani dalam mengatasi tantangan kesehatan
                                            tanaman jagung</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4>Based on Experts</h4>
                                        <p>Representasi pengetahuan dibangun berdasarkan observasi dan validasi dari
                                            pakar</p>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="about" class="doctors">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Tentang Kami</h2>
                    <p>Jaga Jagung Giriroto adalah sebuah platform yang didedikasikan untuk para petani jagung dengan
                ...
                {{-- <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="landing/img/team2.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Fawwaz Ivandra</h4>
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="landing/img/team3.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Maulana Daffa Athaullah Yahya</h4>
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="landing/img/team4.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Vicko Danendra Setyo Yuwono</h4>
